<template>
  <div class="panel teacher">
    <panel-title :title="$route.meta.title">
      ...
      <router-link :to="{name: 'addMeterial',params:{type:'add'}}" tag="span">
        <el-button type="primary" icon="plus" size="small">添加教材</el-button>
      </router-link>
    </panel-title>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template scope="props">
            <router-link :to="{name: 'addMeterial', params: {props: props.row,type:'edit'}}" tag="span">
